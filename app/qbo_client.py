...
class QBOClient:
    ...
    def get_company_info(self) -> dict:
        """
        Example call: fetches CompanyInfo for the connected QuickBooks company.
        """
    ...
    def query(self, query: str) -> dict:
        """
        Run a QuickBooks Online SQL-like query, e.g.:
...
def get_qbo_client_from_db(db: Session) -> QBOClient:
    """
    Get a QBOClient using the first stored row in qbo_tokens.
    This matches your single-company, internal-use architecture.
    """
